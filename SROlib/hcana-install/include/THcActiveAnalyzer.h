#ifndef ROOT_THcActiveAnalyzer
#define ROOT_THcActiveAnalyzer
...
class THcActiveAnalyzer : public THaNonTrackingDetector, public THcHitList {

 public:
  THcActiveAnalyzer(const char* name, const char* description = "", THaApparatus* a = NULL);
  virtual ~THcActiveAnalyzer();
  ...
  THcActiveAnalyzer();  // for ROOT I/O
 protected:
  Bool_t*   fPresentP;
 ...
 THcHodoscope* fglHod;		// Hodoscope to get start time
  ...
  ClassDef(THcActiveAnalyzer,0)        // Generic cherenkov class
};
